...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Figures/Diagrama_de_uso.jpg} % use your image path and name here
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Figures/seq.jpg} % use your image path and name here
